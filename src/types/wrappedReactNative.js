...
export const PermissionsAndroid = wrap(ReactNative.PermmisionsAndroid)
...
export const isIPhoneX = wrap(ReactNative.isIPhoneX)
export const ViewStyle = wrap(ReactNative.ViewStyle)
// Accesability only
...
export const Appearance = ReactNative.Easing
export const Picker = ReactNative.Easing
export const Platform = ReactNative.Easing
...
export const Event = ReactNative.Event
